...
import org.tensorflow.lite.examples.facerecognition.activity.DeleteActivity;
...
public class DeleteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_delete, container, false);
        ...
        delete_btn.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                fragmentManager.beginTransaction().remove(DeleteFragment.this).commit();
