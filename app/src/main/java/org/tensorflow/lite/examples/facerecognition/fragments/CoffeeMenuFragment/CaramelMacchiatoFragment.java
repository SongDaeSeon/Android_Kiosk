...
public class CaramelMacchiatoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        caramelmacchiato_btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                ...
                fragmentManager.beginTransaction().remove(CaramelMacchiatoFragment.this).commit();
    ...
    public void onResume() {
        ...
        tts = new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                caramelmacchiato_btn.setEnabled(true);
                Locale locale = Locale.getDefault();
                tts.setLanguage(locale);
