...
public class CheeseMuffinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cheese_muffin_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String text = "치즈머핀 1800원";
        ...
        cheese_muffin_btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                ...
                fragmentManager.beginTransaction().remove(CheeseMuffinFragment.this).commit();
    ...
    public void onResume() {
        ...
        tts = new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                cheese_muffin_btn.setEnabled(true);
                Locale locale = Locale.getDefault();
                tts.setLanguage(locale);
