...
public class GrapefruitTeaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        grapefruit_tea_btn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        grapefruit_tea_btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                Intent intent = new Intent(getActivity(), SelectIceHotActivity.class);
                intent.putExtra("menu", "자몽차");
                intent.putExtra("price", "2500");
                startActivity(intent);

                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                fragmentManager.beginTransaction().remove(GrapefruitTeaFragment.this).commit();
    ...
    public void onResume() {
        ...
        tts = new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                grapefruit_tea_btn.setEnabled(true);
                Locale locale = Locale.getDefault();
                tts.setLanguage(locale);
