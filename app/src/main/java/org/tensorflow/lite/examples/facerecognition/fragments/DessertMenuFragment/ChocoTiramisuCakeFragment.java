...
public class ChocoTiramisuCakeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        choco_tiramisu_cake_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String text = "초코티라미스 조각케익 2500원";
        ...
        choco_tiramisu_cake_btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                ...
                fragmentManager.beginTransaction().remove(ChocoTiramisuCakeFragment.this).commit();
    ...
    public void onResume() {
        ...
        tts = new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                choco_tiramisu_cake_btn.setEnabled(true);
                Locale locale = Locale.getDefault();
                tts.setLanguage(locale);
